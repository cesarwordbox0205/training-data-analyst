...
def preprocess_train_and_deploy(
    ...
    deploy_app = dsl.ContainerOp(
          name='deployapp',
          # image needs to be a compile-time string
          image='gcr.io/youtubelist-256522/babyweight-pipeline-deployapp:latest',
          arguments=[
...
def train_and_deploy_helper(preprocess, hparam_train):
    ...
    train_tuned = dsl.ContainerOp(
      name='traintuned',
      # image needs to be a compile-time string
      image='gcr.io/youtubelist-256522/babyweight-pipeline-traintuned:latest',
      arguments=[
    ...
    deploy_cmle = dsl.ContainerOp(
      name='deploycmle',
      # image needs to be a compile-time string
      image='gcr.io/youtubelist-256522/babyweight-pipeline-deploycmle:latest',
      arguments=[
